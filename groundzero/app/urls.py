...
from .views import index, formulario, inicio, imagen1, imagen2, imagen3, imagen4, imagen5, imagen6, imagen7, imagen8, agregar_producto, listar_productos, modificar_producto,eliminar_producto, galeria, servicio
